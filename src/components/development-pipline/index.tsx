                  ...
                  <div key={index} className="relative">
                    ...
                    {index < pipelineData.length - 1 && (
                      <>
                        ...
                        <div className="absolute top-1/3 left-[10%] sm:left-[20%] w-[400px] md:w-[550px] h-0.5 bg-gradient-to-r from-[#2563EB] via-[#1FBAFF00] via-[#2FBAF8] via-[#1EE2FF00] to-[#34E5FF]">
