...
const BorderGradientButton = ({ text }: ButtonProps) => {
  return (
    <button className=" w-[206px] relative inline-block px-6 py-2 rounded-[35px] dark:bg-black bg-white dark:text-[#EAEAEA] text-[#272828] font-semibold z-10 overflow-hidden group">
